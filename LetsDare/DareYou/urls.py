...
urlpatterns = [
    ...
    path('daresharedgav/',views.DareSharedGenericAPIView.as_view(), name='daresharedgav'),
    path('daresharedgav/<id>/',views.DareSharedGenericAPIView.as_view(), name='daresharedgavwithid'),
